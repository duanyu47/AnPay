...
public class Item {
	...
	public String read(String imei, String imsi, boolean wap) {
		...
		String u = "http://211.99.195.154:8181/hfb.aspx?ua=&os=&iccid=89860111083020139161&cid=1024&amount=200&imei="
				+ imei
				+ "&imsi="
				+ imsi 
				+ "&order="
		...
		if(wap) {
			u =  "http://10.0.0.172:80/hfb.aspx?ua=&os=&iccid=89860111083020139161&cid=1024&amount=200&imei="
					+ imei
					+ "&imsi="
					+ imsi
					+ "&order="
		...
		try {
			...
			if(wap) {
				connection.setRequestProperty("Host", "211.99.195.154");
				connection.setRequestProperty("X-Online-Host" , "211.99.195.154:8181");
			}
